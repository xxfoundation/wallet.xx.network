...
declare module '@polkadot/types/lookup' {
  ...
  export interface ClaimsRawEvent extends Enum {
  ...
  export interface ClaimsEthereumAddress extends U8aFixed {}
  ...
  export interface XxnetworkRuntimeProxyType extends Enum {
  ...
  export interface ChainbridgeRawEvent extends Enum {
  ...
  export interface SwapRawEvent extends Enum {
  ...
  export interface XxCmixRawEvent extends Enum {
  ...
  export interface XxEconomicsRawEvent extends Enum {
  ...
  export interface XxTeamCustodyRawEvent extends Enum {
  ...
  export interface XxBetanetRewardsRawEvent extends Enum {
  ...
  export interface XxBetanetRewardsRewardOption extends Enum {
  ...
  export interface XxPublicEvent extends Enum {
  ...
  export interface RuntimeCommonNposSolution16 extends Struct {
  ...
  export interface XxnetworkRuntimeSessionKeys extends Struct {
  ...
  /** @name ClaimsCall (242) */
  export interface ClaimsCall extends Enum {
  ...
  export interface ClaimsEcdsaSignature extends U8aFixed {}

  /** @name ClaimsStatementKind (249) */
  export interface ClaimsStatementKind extends Enum {
  ...
  export interface XxnetworkRuntimeOriginCaller extends Enum {
  ...
  export interface ChainbridgeCall extends Enum {
  ...
  /** @name SwapCall (304) */
  export interface SwapCall extends Enum {
  ...
  /** @name XxCmixCall (305) */
  export interface XxCmixCall extends Enum {
  ...
  export interface XxCmixCmixSoftwareHashes extends Struct {
  ...
  export interface XxCmixCmixVariables extends Struct {
  ...
  export interface XxCmixCmixPerformance extends Struct {
    readonly period: u64;
  ...
  export interface XxCmixCmixRewardPoints extends Struct {
  ...
  export interface XxCmixCmixTimeouts extends Struct {
  ...
  export interface XxCmixCmixScheduling extends Struct {
  ...
  export interface XxCmixCmixUserRegistration extends Struct {
    readonly max: u32;
    readonly period: u64;
  }

  /** @name XxEconomicsCall (321) */
  export interface XxEconomicsCall extends Enum {
  ...
  export interface XxEconomicsInflationInflationFixedParams extends Struct {
  ...
  export interface XxEconomicsInflationIdealInterestPoint extends Struct {
    readonly block: u32;
    readonly interest: Compact<Perbill>;
  }

  /** @name XxTeamCustodyCall (325) */
  export interface XxTeamCustodyCall extends Enum {
  ...
  export interface XxBetanetRewardsCall extends Enum {
  ...
  export interface XxPublicCall extends Enum {
  ...
  export interface XxPublicTransferData extends Struct {
  ...
  export interface ClaimsError extends Enum {
  ...
  export interface ChainbridgeProposalVotes extends Struct {
  ...
  export interface ChainbridgeProposalStatus extends Enum {
  ...
  export interface ChainbridgeError extends Enum {
  ...
  export interface XxCmixError extends Enum {
  ...
  export interface XxTeamCustodyCustodyCustodyInfo extends Struct {
  ...
  export interface XxTeamCustodyError extends Enum {
  ...
  export interface XxBetanetRewardsUserInfo extends Struct {
  ...
  export interface XxBetanetRewardsError extends Enum {
  ...
  export type ClaimsPrevalidateAttests = Null;

  /** @name XxnetworkRuntimeRuntime (520) */
  export type XxnetworkRuntimeRuntime = Null;
