...
import { BalanceCustomized } from '@polkadot/react-query';
  ...
  return (
    ...
    >
      <Modal.Content>
        ...
        />
        {startBalance && (
          <Modal.Columns hint={t<string>('The amount to be rebonded from the value currently unlocking, i.e. previously unbonded')}>
            <InputBalance
              autoFocus
